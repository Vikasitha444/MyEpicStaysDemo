# Generated by Django 5.2.3 on 2025-08-21 04:08
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('long_description', models.TextField()),
                ('short_description', models.CharField(max_length=255)),
                ('property_category_id', models.BigIntegerField()),
                ('location', models.CharField(max_length=255)),
                ('district_id', models.BigIntegerField()),
                ('default_picture_id', models.BigIntegerField()),
                ('google_maps_pin', models.CharField(max_length=255)),
                ('verified', models.BooleanField()),
                ('verified_timestamp', models.DateTimeField()),
                ('verified_notes', models.TextField()),
                ('enabled', models.BooleanField()),
                ('next_verification', models.DateTimeField()),
                ('created_at', models.DateTimeField()),
                ('updated_at', models.DateTimeField()),
            ],
            options={
